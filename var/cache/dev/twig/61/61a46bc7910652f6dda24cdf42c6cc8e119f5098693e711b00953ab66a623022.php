...
class __TwigTemplate_a1199d7785e9b9e639045bb00f94eec11bd390445ca78395f82d277242b8d3be extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <div class=\"row\">
        ...
        <div class=\"bg-ligth py-3 px-3\">
            ...
            ";
        // line 16
        if ((isset($context["hasError"]) || array_key_exists("hasError", $context) ? $context["hasError"] : (function () { throw new RuntimeError('Variable "hasError" does not exist.', 16, $this->source); })())) {
            // line 17
            echo "                <div class=\"alert alert-danger\">Une erreur est survenue, email ou mot de passe invalide</div>
            ";
        }
        // line 19
        echo "            <form action=\"";
...
";
    ...
    {
        return array (  113 => 22,  106 => 19,  102 => 17,  100 => 16,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
    ...
    <div class=\"row\">
        ...
        <div class=\"bg-ligth py-3 px-3\">
            ...
            {% if hasError %}
                <div class=\"alert alert-danger\">Une erreur est survenue, email ou mot de passe invalide</div>
            {% endif %}
