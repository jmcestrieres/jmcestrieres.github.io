...
class __TwigTemplate_b3f7b259b53373e39b6da273550b7e42e38b7269a7a316d322a5004a79d16dff extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"col-10\">
            <div class=\"row\">
                <div class=\"col\">
                    ";
        // line 33
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 33, $this->source); })()), "url", [], "any", false, false, false, 33), 'widget');
        echo "
                    ";
        // line 34
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 34, $this->source); })()), "url", [], "any", false, false, false, 34), 'errors');
        echo "
                </div>
                <div class=\"col\">
                    ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "caption", [], "any", false, false, false, 37), 'widget');
        echo "
                    ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 38, $this->source); })()), "caption", [], "any", false, false, false, 38), 'errors');
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  177 => 43,  169 => 38,  165 => 37,  159 => 34,  155 => 33,  147 => 28,  143 => 27,  140 => 26,  130 => 25,  117 => 20,  114 => 19,  104 => 18,  83 => 5,  78 => 2,  68 => 1,  58 => 25,  54 => 23,  52 => 18,  48 => 16,  46 => 1,);
    }
...
{% endblock %}", "ad/_collection.html.twig", "/var/www/html/symbnb/templates/ad/_collection.html.twig");
    }
}
